...
function getMongoDbQueryResolver(graphQLType, queryCallback, queryOptions) {
    ...
    var requiredQueryOptions = __assign({}, defaultOptions, queryOptions);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    projection = requiredQueryOptions.differentOutputType ? undefined : mongoDbProjection_1.getMongoDbProjection(info, graphQLType);
                    options = {};
                    if (args.sort)
